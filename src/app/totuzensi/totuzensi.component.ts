...
@Component({
  ...
  selector: 'app-totuzensi',
  templateUrl: './totuzensi.component.html',
  styleUrls: ['./totuzensi.component.css'],
  animations: [fadeInAnimation],
  host: { '[@fadeInAnimation]': '' }
})
export class TotuzensiComponent implements OnInit {
...
//nw = ["乡", "乌", "丽", "两", "业", "淘宝網", "HUAWEI", "HUAWEI", "HUAWEI", "ファーウェイウェイ", "貴様", "贵", "レ", "ふ", "て", '应', 'ヌ', '杂', "货", "见", "溃", "ぬ", "ギ", "そ", "舐", "绝", "对", "慧", "贮", "们", "cn", "CCTV", "HUAWEI", "人民元", "alipay", "WechatPay", "weibo", "ウェイボ", "Tiktok", "Tiktok", "wechat", "wechat", "wechat", "风", "(しなさい)", "强", "北京", "深圳", "百度", "百度", "百度", "上海中心", "shanghai tower", "上海", "八゜", "亚马逊", "亚马逊", "乘", "黑", "Kirin", "NM", "荒野行動", "極度勞動", "东", "うーメソ", "🇨🇳", "🇨🇳", "🇨🇳", "🇨🇳", "🇨🇳", "🇨🇳", "🇨🇳", "🇨🇳", "🇨🇳", "才", "爱", "语", "ゐ", "ゑ", "HUAWEI", "ファーウェイ", "た", "變", "荣", "强", "ラ", "八", "应", "伟", "义", "结", "协", "调", "剂", "樣", "乜", '动', "评", "华为技术有限公司", "华为技术有限公司"];
 // len = this.old.length;
  ...
  tweet() {
    var turl = "https://twitter.com/intent/tweet?text=" + this.OUTE + "&url=https://correctjp.work&hashtags=突然の死ジェネレーター";
  ...
  inputText() {
    function curl(MES) {
      $.ajax({
        type: "GET",
        url: "//teem.pythonanywhere.com/totuzensi",
        data: "text=" + MES,
        async: false
      }).done(function (msg) {
