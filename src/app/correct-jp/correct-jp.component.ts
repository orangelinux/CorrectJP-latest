...
var msg = "";
@Component({
  selector: 'app-correct-jp',
  moduleId: module.id.toString(),
  templateUrl: './correct-jp.component.html',
  styleUrls: ['./correct-jp.component.css'],
  animations: [fadeInAnimation],
  host: { '[@fadeInAnimation]': '' }
})
export class CorrectJPComponent implements OnInit {
