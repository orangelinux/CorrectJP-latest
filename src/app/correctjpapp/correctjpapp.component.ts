...
var msg = "";
@Component({
  selector: 'app-correctjpapp',
  moduleId: module.id.toString(),
  templateUrl: './correctjpapp.component.html',
  styleUrls: ['./correctjpapp.component.css'],
  animations: [fadeInAnimation],
  host: { '[@fadeInAnimation]': '' }
})
export class CorrectjpappComponent implements OnInit {
 ...
 // len = this.old.length;
  ...
  inputText() {
    function curl(MES) {
      $.ajax({
        type: "GET",
        url: "//teem.pythonanywhere.com/app",
        data: "text=" + MES,
        async: false
      }).done(function (msg) {
